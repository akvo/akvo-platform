## Modified version of the code found at https://www.jhanley.com/google-cloud-converting-service-account-credentials-from-p12-to-json-format/
## Reproduced with permission of John J. Hanley
############################################################
# Version 1.00
